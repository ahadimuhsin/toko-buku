...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand p-0">
         ...
         {{-- Membuat Navbar dan Side Bar Menu yg Fluid --}}
            ...
            <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
                <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
                    <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                        ...
                        {{--Memeriksa apakah roles user yang sedang login, ada ADMIN atau tidak.--}}
                       @if(array_intersect(["ADMIN"], json_decode(\Auth::user()->roles)))
                        {{-- @if(in_array("ADMIN", array(Auth::user()->roles))) --}}
                        <li><a href="{{route('users.index')}}"><span class="oi oi-people"></span>Users</a> </li>
                        @endif
                        <li><a href="{{ route('categories.index') }}"><span class="oi oi-tag"></span>Categories</a></li>
                        <li><a href="{{ route('books.index') }}"><span class="oi oi-book"></span>Books</a></li>
                        <li><a href="{{ route('orders.index') }}"><span class="oi oi-cart"></span>Orders</a></li>
                        <li><a href="{{ route('maps.index') }}"><span class="oi oi-map"></span>Maps</a></li>
